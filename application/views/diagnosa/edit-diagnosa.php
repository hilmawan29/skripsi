<div class="container-fluid">
    ...
    <?= form_open('diagnosa/editpat/' . $patient['id']); ?>
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <input type="datetime-local" class="form-control" id="check_in" disabled="disabled" name="check_in" value="<?= $newDate; ?>">
            <?= form_error('check_in', '<small class="text-danger pl-3">', '</small>'); ?>
        </div>
        <div class="form-group">
            <label for="check_out">Jam Keluar</label>
            <input type="time" class="form-control" id="check_out" disabled="disabled" name="check_out" value="<?= $patient['check_out']; ?>">
