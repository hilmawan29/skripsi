  ...
  <body>
    ...
    <header class="header-about">
      <main class="main-body">
        <h2 class="h2-artikel"><?php echo $artikel['judul']; ?></h2>
        <article class="card">
         <?php $gambar = $artikel['gambar']; ?>
          <img src="<?php echo base_url("assets/image/$gambar"); ?>" height="700px" class="card-img-top" alt="<?php echo $artikel['judul']; ?>">
